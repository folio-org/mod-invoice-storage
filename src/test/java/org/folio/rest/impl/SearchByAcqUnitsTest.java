...
public class SearchByAcqUnitsTest extends TestBase {
  ...
  public void testSearchByVoucherAcqUnitsAssigns() throws MalformedURLException {
    ...
    String acqUnitQuery = "?query=acquisitionsUnitAssignments.acquisitionsUnitId==" + acqUnitAssignment.getAcquisitionsUnitId();
    ...
    verifySearchVoucherLinesByAcqUnit(acqUnitQuery + " or acquisitionsUnitAssignments.acquisitionsUnitId==" + acqUnitId, acqUnitAssignment.getRecordId());
    verifySearchVouchersByAcqUnit(acqUnitQuery + " or acquisitionsUnitAssignments.acquisitionsUnitId==" + acqUnitId, acqUnitAssignment.getRecordId());
  }
