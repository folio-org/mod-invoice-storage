...
public class HelperUtilsTest extends TestBase {
  ...
  public void getEntitiesCollectionWithDistinctOnFailCqlExTest() throws Exception {
    ...
    get(storageUrl(VOUCHER_LINES_ENDPOINT)).statusCode(HttpStatus.HTTP_BAD_REQUEST.toInt()).contentType(TEXT_PLAIN);
  }
  ...
  public void entitiesMetadataHolderRespond400FailTest() throws Exception {
    ...
    get(storageUrl(VOUCHER_LINES_ENDPOINT)).statusCode(HttpStatus.HTTP_INTERNAL_SERVER_ERROR.toInt()).contentType(TEXT_PLAIN);
  }
